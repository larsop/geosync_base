package no.geonorge.subscriber.Arealressurs;
 ...
 */
@Entity
@Table(name =  "ar5_geosync_flate", schema = "ar5")
@SequenceGenerator(name = "ID_SEQ", sequenceName = "ar5.ar5_geosync_flate_id_seq")
@Proxy(lazy = false)
public class Ar5FlateEntity implements java.io.Serializable {
	...
	public boolean equals(Object o) {
		if (!(o instanceof Ar5FlateEntity)) {
			return false;
		}

		Ar5FlateEntity rhs = (Ar5FlateEntity) o;
