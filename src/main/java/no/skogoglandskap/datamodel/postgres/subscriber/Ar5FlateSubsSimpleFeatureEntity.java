package no.skogoglandskap.datamodel.postgres.subscriber;
 ...
 * 
 * This is where we find the subscriber data. 
 * 
 ...
 */
@Entity
@Table(name =  "ar5_flate", schema = "sde_ar5_subs")
@SequenceGenerator(name = "ID_SEQ", sequenceName = "ar5.ar5_flate_id_seq")
@Proxy(lazy = false)
public class Ar5FlateSubsSimpleFeatureEntity implements java.io.Serializable {
	...
	public Ar5FlateSubsSimpleFeatureEntity() {
	}
	...
	public boolean equals(Object o) {
		if (!(o instanceof Ar5FlateSubsSimpleFeatureEntity)) {
			return false;
		}

		Ar5FlateSubsSimpleFeatureEntity rhs = (Ar5FlateSubsSimpleFeatureEntity) o;
